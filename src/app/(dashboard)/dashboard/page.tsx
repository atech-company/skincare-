...
const statCards: {
  ...
  { key: "total_patients", label: "Total Patients", icon: Users, color: "from-violet-500 to-purple-600", href: "/patients" },
  { key: "today_sessions", label: "Today's Sessions", icon: Calendar, color: "from-indigo-500 to-blue-600", href: "/treatments" },
  { key: "revenue_this_month", label: "Revenue (Month)", icon: DollarSign, color: "from-emerald-500 to-teal-600", format: "currency", href: "/payments" },
  ...
  { key: "product_sales_revenue_month", label: "Product Sales (Month)", icon: Package, color: "from-fuchsia-500 to-pink-600", format: "currency", href: "/products" },
];

function DashboardLinkCard({ href, children }: { href: string; children: ReactNode }) {
  return (
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {statCards.map((stat) => {
          ...
          return (
            <DashboardLinkCard key={stat.key} href={stat.href}>
              {inner}
            </DashboardLinkCard>
          );
        })}
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <DashboardLinkCard href="/appointments">
        ...
        <DashboardLinkCard href="/products">
          <Card className="cursor-pointer transition-shadow hover:shadow-md">
            <CardHeader>
        ...
        <DashboardLinkCard href="/payments">
          <Card className="cursor-pointer transition-shadow hover:shadow-md">
            <CardHeader>
        ...
        <DashboardLinkCard href="/timeline">
          <Card className="cursor-pointer transition-shadow hover:shadow-md">
            <CardHeader>
